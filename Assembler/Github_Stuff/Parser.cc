...
int main()
{
    ...
    while(getline(inFile, line))
    {
        char *token = std::strtok(&line[0], " \t , ");
            ...
            else if(str[0] =="addx") {outFile << "01101000000"<<DecToBin(str[3], 7)<<DecToBin(str[2], 7)<<DecToBin(str[1], 7)<<endl;}  // 2 - addx - Add Extended
            ...
            else if(str[0] =="br") {outFile << "001100100"<<DecToBin(str[1], 16)<<DecToBin(str_null, 7)<<endl;}  // 43 - br - Branch Relative
            else if(str[0] =="bra") {outFile << "001100000"<<DecToBin(str[1], 16)<<DecToBin(str_null, 7)<<endl;}  // 44 - bra - Branch Absolute
            ...
            else {outFile << str[0] <<" Instruction_not_Found"<<endl;}}
    }
    outFile.close();
}
